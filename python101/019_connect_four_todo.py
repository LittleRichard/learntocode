...
def get_next_free_row_in_column(col_number, board_state):
    ...
    return 0 # this is broken... just demonstrates the return value
    # what should you return if the column is full?

# create the board state that will track th
board_state = []
BOARD_HEIGHT = 11 # standard is 6
BOARD_WIDTH = 15 # standard is 7
...
# show the board
print(get_board_display(board_state, debug_mode=True))
# player 1 goes first
current_player = PLAYER_1_STR

# TODO: this 'while True' will loop forever.
while True: 
    ...
    # finally, print the board state so that the next player's
