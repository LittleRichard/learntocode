...
if 'passport' not in checked_bag and 'passport' not in carry_on_bag:
    exit('cancelled trip, missing: %s' % 'passport')
...
if 'passport' in checked_bag:
    ...
    assert 'passport' in carry_on_bag, "no passport... cancel trip"
...
assert carry_on_bag['cash'] > 124.99, 'uh oh, ran out of cash...'
...
if 'sunscreen' not in carry_on_bag and 'sunscreen' not in checked_bag:
    ...
    assert 'sunscreen' in carry_on_bag, 'logic tree is broken...'
